...
{
    public class SamplePatternContainer : PatternsContainer<SamplePatternData>
    {
        public override void AddPattern(string patternId, SamplePatternData pattern)
        {
        ...
        public override void ChangePattern(string oldPatternId, string newPatternId, SamplePatternData pattern)
        {
